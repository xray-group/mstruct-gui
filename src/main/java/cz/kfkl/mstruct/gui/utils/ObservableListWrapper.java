 ...
 * 
 * Copied from the Java implementation as it was not accessible. Also was
 * slightly simplified.
 *
 */
public class ObservableListWrapper<E> extends ModifiableObservableListBase<E> implements ObservableList<E>, RandomAccess {
