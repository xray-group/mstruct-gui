...
/**
 * Copied from the Java implementation as it was not accessible.
 */
final class ElementObserver<E> {
	...
	private IdentityHashMap<E, ElementObserver.ElementsMapElement> elementsMap = new IdentityHashMap<E, ElementObserver.ElementsMapElement>();
